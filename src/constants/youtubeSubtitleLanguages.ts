// YouTube's auto-translate languages, taken from yt-dlp's caption
// listing, in alphabetical order.

export type SubtitleLanguage = { code: string; name: string };

export const YOUTUBE_SUBTITLE_LANGUAGES: SubtitleLanguage[] = [
    ...
    { code: "tt", name: "Tatar" },
    { code: "te", name: "Telugu" },
    { code: "te-orig", name: "Telugu (Original)" },
    { code: "th", name: "Thai" },
